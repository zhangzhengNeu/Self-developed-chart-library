...
import { a as groupBy, b as isLeafNode, l as fromEntries, n as CaretRight16, g as getTreeDepth, _ as __rest, B as BaseTable, C as Classes, m as makeTreeModeTransform } from './chunks/ali-react-table-treeMode-d713dac0.esm.js';
...
function CrossTable(_a) {
    ...
    return (React.createElement(StyledBaseTableForCrossTable, Object.assign({}, others, { dataSource: dataSource, columns: columns, primaryKey: ROW_KEY, className: cx('compact', className) })));
}
...
export { CrossTable, CrossTableClasses, CrossTreeTable, ROW_KEY, StyledBaseTableForCrossTable, buildCrossTable, buildCrossTreeTable, buildDrillTree, buildRecordMap, buildRecordMatrix, convertDrillTreeToCrossTree, simpleEncode };
