...
var treeMode = require('./ali-react-table-treeMode-d04f1638.js');
...
function buildTree(idProp, parentIdProp, items) {
    ...
    const topLevelWrappers = treeMode.flatMap(Array.from(wrapperMap.values()).filter((wrapper) => wrapper.parent == null), (wrapper) => wrapper.children);
...
function safeGetSpanRect(column, record, rowIndex, colIndex) {
    ...
    if (column.getSpanRect) {
        const value = treeMode.safeGetValue(column, record, rowIndex);
        ...
        const cellProps = treeMode.safeGetCellProps(column, record, rowIndex);
...
function exportTableAsExcel(xlsxPackage, dataSource, columns, filename) {
    ...
    const topHeaderHeight = treeMode.getTreeDepth(columns) + 1;
    ...
    function addDataPart(origin) {
        const leafColumns = treeMode.collectNodes(columns, 'leaf-only').filter((col) => { var _a; return !((_a = col.features) === null || _a === void 0 ? void 0 : _a.noExport); });
        const spanManager = new treeMode.SpanManager();
        const dataPart = dataSource.map((record, rowIndex) => {
            ...
            return leafColumns.map((col, colIndex) => {
                ...
                return sanitizeCellDatum(treeMode.safeGetValue(col, record, rowIndex));
            });
        });
        add(dataPart, origin);
    }
...
function makeAutoRowSpanTransform() {
    return traverseColumn((col, { dataSource, range }) => {
        ...
        for (let rowIndex = 0; rowIndex < dataSource.length; rowIndex++) {
            const value = treeMode.safeGetValue(col, dataSource[rowIndex], rowIndex);
...
function makeColumnResizeTransform({ sizes, onChangeSizes, minSize = 40, maxSize = Infinity, appendExpander, disableUserSelectWhenResizing, }) {
    const startResize = (colIndex, e) => {
        ...
        const nextSizes$ = rxjs.fromEvent(window, 'mousemove').pipe(op.takeUntil(rxjs.fromEvent(window, 'mouseup')), op.map((e) => {
    ...
    const innerTransform = traverseColumn((col, { range }) => {
        ...
        const prevTitle = treeMode.safeRenderHeader(col);
        return Object.assign(Object.assign({}, col), { width: sizes[range.start], title: (React__default.createElement(React__default.Fragment, null,
                prevTitle,
                React__default.createElement(ResizeHandle, { className: "resize-handle", onMouseDown: (e) => startResize(range.start, e) }))), headerCellProps: Object.assign(Object.assign({}, col.headerCellProps), { style: Object.assign(Object.assign({}, (_a = col.headerCellProps) === null || _a === void 0 ? void 0 : _a.style), { overflow: 'visible', position: 'relative' }) }) });
    });
    return (input) => {
...
function useColumnResizeTransform(_a) {
    var { defaultSizes } = _a, others = treeMode.__rest(_a, ["defaultSizes"]);
...
var Number_116 = /*#__PURE__*/React__default.forwardRef(function Number_116(_ref, ref) {
  var children = _ref.children,
      rest = treeMode._objectWithoutProperties(_ref, ["children"]);
...
var Number_216 = /*#__PURE__*/React__default.forwardRef(function Number_216(_ref, ref) {
  var children = _ref.children,
      rest = treeMode._objectWithoutProperties(_ref, ["children"]);
...
var Number_316 = /*#__PURE__*/React__default.forwardRef(function Number_316(_ref, ref) {
  var children = _ref.children,
      rest = treeMode._objectWithoutProperties(_ref, ["children"]);
...
var Number_416 = /*#__PURE__*/React__default.forwardRef(function Number_416(_ref, ref) {
  var children = _ref.children,
      rest = treeMode._objectWithoutProperties(_ref, ["children"]);
...
var Number_516 = /*#__PURE__*/React__default.forwardRef(function Number_516(_ref, ref) {
  var children = _ref.children,
      rest = treeMode._objectWithoutProperties(_ref, ["children"]);
...
var Number_616 = /*#__PURE__*/React__default.forwardRef(function Number_616(_ref, ref) {
  var children = _ref.children,
      rest = treeMode._objectWithoutProperties(_ref, ["children"]);
...
var Number_716 = /*#__PURE__*/React__default.forwardRef(function Number_716(_ref, ref) {
  var children = _ref.children,
      rest = treeMode._objectWithoutProperties(_ref, ["children"]);
...
var Number_816 = /*#__PURE__*/React__default.forwardRef(function Number_816(_ref, ref) {
  var children = _ref.children,
      rest = treeMode._objectWithoutProperties(_ref, ["children"]);
...
var Number_916 = /*#__PURE__*/React__default.forwardRef(function Number_916(_ref, ref) {
  var children = _ref.children,
      rest = treeMode._objectWithoutProperties(_ref, ["children"]);
...
function SortIcon({ size = 32, style, className, order, }) {
    return (React__default.createElement("svg", { style: style, className: className, focusable: "false", preserveAspectRatio: "xMidYMid meet", width: size, height: size, viewBox: "0 0 32 32", "aria-hidden": "true" },
        React__default.createElement("path", { fill: order === 'asc' ? '#23A3FF' : '#bfbfbf', transform: "translate(0, 4)", d: "M8 8L16 0 24 8z" }),
        React__default.createElement("path", { fill: order === 'desc' ? '#23A3FF' : '#bfbfbf', transform: "translate(0, -4)", d: "M24 24L16 32 8 24z " })));
}
const NumberIconMap = {
    1: Number_116,
    2: Number_216,
...
function DefaultSortHeaderCell({ children, column, onToggle, sortOrder, sortIndex, sortOptions }) {
    ...
    return (React__default.createElement(TableHeaderCell, { onClick: onToggle, style: { justifyContent } },
        children,
        React__default.createElement(SortIcon, { style: { marginLeft: 2, flexShrink: 0 }, size: 16, order: sortOrder }),
        React__default.createElement(NumberIcon, { style: { fill: '#666', flexShrink: 0 } })));
}
function hasAnySortableColumns(cols) {
    return cols.some((col) => { var _a; return Boolean((_a = col.features) === null || _a === void 0 ? void 0 : _a.sortable) || (!treeMode.isLeafNode(col) && hasAnySortableColumns(col.children)); });
}
...
function makeSortTransform({ sorts: inputSorts, onChangeSorts: inputOnChangeSorts, orders = ['desc', 'asc', 'none'], mode = 'multiple', SortHeaderCell, keepDataSource, }) {
    ...
    return ({ dataSource, columns }) => {
        ...
        function processDataSource(dataSource) {
            ...
            const sortColumnsMap = new Map(treeMode.collectNodes(columns, 'leaf-only')
            ...
            return layeredSort(dataSource, (x, y) => {
                for (const { code, order } of sorts) {
                    ...
                    const xValue = treeMode.safeGetValue(column, x, -1);
                    const yValue = treeMode.safeGetValue(column, y, -1);
        ...
        function processColumns(columns) {
            ...
            function dfs(col) {
                ...
                if (col.code && (((_a = col.features) === null || _a === void 0 ? void 0 : _a.sortable) || sortMap.has(col.code))) {
                    ...
                    result.title = (React__default.createElement(SortHeaderCellComponent, { onToggle: () => toggle(col.code), sortOrder: sortOrder, column: col, sortIndex: sortIndex, sortOptions: sortOptions }, treeMode.safeRenderHeader(col)));
                }
                if (!treeMode.isLeafNode(col)) {
...
function useSortTransform(_a = {}) {
    var { defaultSorts = [] } = _a, others = treeMode.__rest(_a, ["defaultSorts"]);
...
function makeTipsTransform({ Balloon }) {
    return traverseColumn((col) => {
        ...
        return Object.assign(Object.assign({}, col), { title: (React__default.createElement(HeaderCellWithTips, { style: { justifyContent } },
                treeMode.safeRenderHeader(col),
                React__default.createElement(Balloon, { closable: false, trigger: React__default.createElement("div", { className: "tip-icon-wrapper" },
                        React__default.createElement(Information16, { className: "tip-icon" })) }, col.features.tips))) });
    });
}
