...
export declare type ComponentType = 'title' | 'customComponent' | 'footer';
...
export declare type CustomComponent = ReactElement | Vue | HTMLElement | string | null;
export declare type DatasetParams = {
    [key: string]: any;
};
export declare type OptionHandler = (option: {
    [key: string]: any;
    dataset: any;
    series: EChartOption.Series[];
}, datasetParams?: DatasetParams) => void;
